...
def simplex(f, x0, lambda_0, r, alpha, tol=1e-4):
    iter_count = 0
    ...
    while True:
        ...
        values = np.array([f(point, lambda_0, r) for point in simplex])
